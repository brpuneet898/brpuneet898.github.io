...
- **Tools & Software**: Microsoft 365, Jira, AWS, GCP
- **Programming Languages**: Python, Java, C#, JavaScript, DSA, C, Kotlin, Typescript, React-Native, Node JS, C++
- **Libraries & Frameworks**: Numpy, Pandas, Scikit Learn, Seaborn, Matplotlib, Django, Flask, .Net, PyTorch
- **Databases**: SQL, Oracle, PostgreSQL, Firebase
- **Web and Mobile Development**: HTML, MJML, CSS, JavaScript, Bootstrap, PHP, Android Studio, Swift
...
### Teaching Assistant & Content Creator (IIT Madras), July 2025 – Present [^Part-Time,Internship] - [Link](https://github.com/brpuneet898/mtech-oops-course-material)
...
### Lab Assistant & Content Creator (IIT Madras), July 2025 – Present [^Part-Time,Internship] - [Link](https://github.com/brpuneet898/msc-maths-python-programming-lab)
...
### Teaching Assistant & Mentor (IIT Madras BS), May 2024 – Present [^Part-Time,Internship]
- **Introduction to DL Gen AI Teaching Assistant:** (October 2025 - Present)
